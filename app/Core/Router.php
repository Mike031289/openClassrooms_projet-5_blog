...
{
    /**
     * @var Route[] The list of configured routes
     */
     ...
     * Router constructor.
     *
     * @param Route[] $configRoutes An array containing the list of configured routes
